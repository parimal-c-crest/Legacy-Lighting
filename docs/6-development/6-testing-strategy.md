...
| Testing Approach | Manual + Automated (unit ≥70% coverage on business logic, per NFR-MAINT-001; UAT in Milestone 5) |
| Development Methodology | Weekly milestone-based delivery |
| Version | 1.0 |
| Status | Draft |
