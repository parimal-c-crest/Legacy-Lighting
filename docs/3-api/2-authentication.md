...
| Manager | Views/reassigns all projects, tasks, requests; full dashboard/report access |
...
Reference: `3-authorization.md` for the full resource access matrix.
...
- No password history/expiration policy required for MVP (may be added Phase 2)
...
- Account lockout after 5 failed login attempts (15-minute lockout), per NFR-SEC-001
- No CAPTCHA/device verification/IP restrictions required for MVP (internal user base)
