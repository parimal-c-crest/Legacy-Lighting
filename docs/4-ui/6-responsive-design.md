...
| Supported Platforms | Web (desktop-first: 1920x1080 optimal; tablet 768px+; mobile 375px+ read-only) |
| Responsive Framework | Tailwind CSS responsive utilities (matches existing Lovable UI's CSS approach) |
| Version | 1.0 |
| Status | Draft |
