...
| Platform | Web (desktop-first, responsive to tablet/mobile) |
...
> **Naming note:** the live Lovable UI (`lovable-screen/`) uses "Estimator Workbench" as the
> screen title for what these docs call the Task Workbench module, and "All Projects" as the
> screen title for the Projects 360 module. Internal module/folder names in `docs/5-modules/`
> stay `task-workbench` and `projects-360` (technical identifiers); the sidebar labels below
...
│   └── Drafts
│
├── Estimator Workbench          (module: task-workbench)
│   ├── Task List
│   └── Task Board (Kanban)
│
├── All Projects                 (module: projects-360)
│   ├── Project List (List / Kanban / Update Call views)
│   └── Project 360 Detail
│
├── Reports
│   ├── Estimator Workload
...
└── Settings
    ├── Users
    ├── Request Types / Project Types / Locations / Statuses / Priorities
    ├── Connected Systems (NetSuite, OneDrive)
    └── My Profile
```
...
|------|--------|-------------|
| Executive Dashboard | Root | KPI widgets, Monday Meeting View |
| Request Intake | Root | Request queue, creation, drafts |
| Estimator Workbench | Root | Estimator task list/board (module: task-workbench) |
| All Projects | Root | Project list and 360 detail view (module: projects-360) |
| Reports | Root | Core operational reports with export |
| Settings | Root | Users, master data, connected systems, profile |
...
| Menu | Admin | Manager | Processor | Estimator | Viewer |
|------|-------|---------|-----------|-----------|--------|
| Executive Dashboard | ✓ | ✓ | | | ✓ |
| Request Intake | ✓ | ✓ | ✓ | | |
| Task Workbench | ✓ | ✓ | ✓ | ✓ | |
