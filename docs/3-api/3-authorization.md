...
| Role | Description |
|------|-------------|
| Admin | Full system access; user/role management; master data and integration config |
| Manager | Views/reassigns all projects, tasks, requests; full dashboard/report access; overrides status/deadlines |
| Processor | Manages request intake; converts requests to tasks; assigns estimators |
| Estimator | Views/updates only assigned tasks |
...
| Resource | Admin | Manager | Processor | Estimator | Viewer |
|----------|-------|---------|-----------|-----------|--------|
| Users / Master Data | Manage | View | — | — | — |
| Requests | Manage | Manage | Manage | View own | View |
| Tasks | Manage | Manage | Assign | Manage own | View |
| Projects | Manage | Manage | View | View | View |
| Dashboard & Reports | View | View | — | — | View (dashboard only) |
| Integrations (NetSuite/OneDrive) | Manage | View | View | View | View |

> Detailed per-endpoint permissions are documented alongside each module's `7-permissions.md`
> in `docs/5-modules/`.
