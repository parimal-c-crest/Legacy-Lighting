...
| Workflow Scope | Feature Development across 5 milestones (see `1-project/1-project-overview.md`) |
| Development Methodology | Weekly milestone-based delivery with weekly stakeholder reviews |
| Version | 1.0 |
| Status | Draft |
